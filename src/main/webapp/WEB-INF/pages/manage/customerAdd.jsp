...
<div id="main" class="wrap">
    ...
    <div class="main">
        <h2>新增用户</h2>
        <div class="manage">
            <form action="AddCustomer.do" method="post" enctype="multipart/form-data">
                <table class="form">
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="text" name="sex" /></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="text" name="phoneNumber" /></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="field">头像:<img style="width: 60px;height: 40px" ></td>
