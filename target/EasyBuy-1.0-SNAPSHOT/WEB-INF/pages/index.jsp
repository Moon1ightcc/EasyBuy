...
<html>
  ...
  <div id="header" class="wrap">
    ...
    <div class="help"><a href="#" class="shopping">购物车</a><a href="${pageContext.request.contextPath}/">登录</a><a href="${pageContext.request.contextPath}/register">注册</a><a href="guestbook.html">留言</a></div>
    <div class="navbar">
      <ul class="clearfix">
